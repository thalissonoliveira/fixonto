 ...
 * @generated
 */
public class AcaoLogicoLadoDireitoAcaoReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public AcaoLogicoLadoDireitoAcaoReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAcaoLogicoLadoDireitoAcao_4019(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAcaoLogicoLadoDireitoAcao_4019(getOldSource(),
						getNewTarget());
	}
