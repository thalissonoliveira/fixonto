 ...
 * @generated
 */
public class AcaoLogicoLadoEsquerdoAcaoReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public AcaoLogicoLadoEsquerdoAcaoReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAcaoLogicoLadoEsquerdoAcao_4018(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAcaoLogicoLadoEsquerdoAcao_4018(getOldSource(),
						getNewTarget());
	}
