 ...
 * @generated
 */
public class AcaoLogicoLadoEsquerdoAcaoReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AcaoLogicoLadoEsquerdoAcaoReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAcaoLogicoLadoEsquerdoAcao_4018(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAcaoLogicoLadoEsquerdoAcao_4018(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setLadoEsquerdoAcao(null);
		getNewSource().setLadoEsquerdoAcao(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setLadoEsquerdoAcao(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
