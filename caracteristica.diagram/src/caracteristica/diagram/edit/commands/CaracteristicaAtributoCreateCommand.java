 ...
 * @generated
 */
public class CaracteristicaAtributoCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CaracteristicaAtributoCreateCommand(
	...
	public boolean canExecute() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateCaracteristicaAtributo_4004(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getAtributo().add(getTarget());
		}
