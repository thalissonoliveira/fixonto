...
public class CaracteristicaProdutoCaracteristicaProdutoFilhaCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof CaracteristicaProduto) {
			return false;
		}
		if (getSource() == null) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getCaracteristicaProdutoFilha().add(getTarget());
		}
	 ...
	 * @generated
	 */
	protected CaracteristicaProduto getTarget() {
		return (CaracteristicaProduto) target;
	}
}
