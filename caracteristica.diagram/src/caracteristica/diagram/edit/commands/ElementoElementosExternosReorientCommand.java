 ...
 * @generated
 */
public class ElementoElementosExternosReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ElementoElementosExternosReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof Elemento) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof ElementoExterno && newEnd instanceof Elemento)) {
			return false;
		}
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistElementoElementosExternos_4027(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistElementoElementosExternos_4027(getOldSource(),
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Elemento getOldSource() {
		return (Elemento) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected Elemento getNewSource() {
		return (Elemento) newEnd;
	}
