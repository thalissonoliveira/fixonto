...
public class ExpressaoLogicaLadoDireitoComposicaoReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistExpressaoLogicaLadoDireitoComposicao_4020(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistExpressaoLogicaLadoDireitoComposicao_4020(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setLadoDireitoComposicao(null);
		getNewSource().setLadoDireitoComposicao(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setLadoDireitoComposicao(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
