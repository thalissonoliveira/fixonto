 ...
 * @generated
 */
public class ExpressaoLogicaLadoEsquerdoComposicaoCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ExpressaoLogicaLadoEsquerdoComposicaoCreateCommand(CreateRelationshipRequest request, EObject source,
			EObject target) {
	...
	public boolean canExecute() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateExpressaoLogicaLadoEsquerdoComposicao_4032(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setLadoEsquerdoComposicao(getTarget());
		}
