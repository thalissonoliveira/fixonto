 ...
 * @generated
 */
public class RaizDeContextoEntidadesDeContextoReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RaizDeContextoEntidadesDeContextoReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRaizDeContextoEntidadesDeContexto_4027(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CaracteristicaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRaizDeContextoEntidadesDeContexto_4027(getOldSource(),
						getNewTarget());
	}
