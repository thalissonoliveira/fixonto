 ...
 * @generated
 */
public class AcaoLogicoOperadorAcaoLogicoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AcaoLogicoOperadorAcaoLogicoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.AcaoLogico_2008,
					getParserElement(), CaracteristicaVisualIDRegistry
							.getType(caracteristica.diagram.edit.parts.AcaoLogicoOperadorAcaoLogicoEditPart.VISUAL_ID));
		}
		return parser;
	}
