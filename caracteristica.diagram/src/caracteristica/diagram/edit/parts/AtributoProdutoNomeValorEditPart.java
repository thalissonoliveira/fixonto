 ...
 * @generated
 */
public class AtributoProdutoNomeValorEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AtributoProdutoNomeValorEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.AtributoProduto_2030,
					getParserElement(), CaracteristicaVisualIDRegistry
							.getType(caracteristica.diagram.edit.parts.AtributoProdutoNomeValorEditPart.VISUAL_ID));
		}
		return parser;
	}
