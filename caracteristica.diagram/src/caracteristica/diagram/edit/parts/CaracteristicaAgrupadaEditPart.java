...
import utils.TriangleFigure;
import caracteristica.diagram.edit.policies.CaracteristicaAgrupadaItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaracteristicaAgrupadaEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CaracteristicaAgrupadaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CaracteristicaAgrupadaItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CaracteristicaAgrupadaFigure();
	}

	/**
	 * @generated
	 */
	public CaracteristicaAgrupadaFigure getPrimaryShape() {
		return (CaracteristicaAgrupadaFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CaracteristicaAgrupadaNomeEditPart) {
			((CaracteristicaAgrupadaNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCaracteristicaAgrupadaLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof caracteristica.diagram.edit.parts.CaracteristicaAgrupadaEditPart) {
			types.add(CaracteristicaElementTypes.CaracteristicaCaracteristicaFilha_4002);
		}
	 ...
	 * @generated
	 */
	public class CaracteristicaAgrupadaFigure extends TriangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureCaracteristicaAgrupadaLabelFigure;

		/**
		 * @generated
		 */
		public CaracteristicaAgrupadaFigure() {
			createContents();
		}
		...
		private void createContents() {
			...
			fFigureCaracteristicaAgrupadaLabelFigure = new WrappingLabel();

			fFigureCaracteristicaAgrupadaLabelFigure
					.setText("CaracteristicaAgrupada");

			this.add(fFigureCaracteristicaAgrupadaLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCaracteristicaAgrupadaLabelFigure() {
			return fFigureCaracteristicaAgrupadaLabelFigure;
		}
