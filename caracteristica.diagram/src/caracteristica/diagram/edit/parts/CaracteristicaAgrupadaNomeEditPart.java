 ...
 * @generated
 */
public class CaracteristicaAgrupadaNomeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CaracteristicaAgrupadaNomeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.CaracteristicaAgrupada_2033,
					getParserElement(), CaracteristicaVisualIDRegistry
							.getType(caracteristica.diagram.edit.parts.CaracteristicaAgrupadaNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
