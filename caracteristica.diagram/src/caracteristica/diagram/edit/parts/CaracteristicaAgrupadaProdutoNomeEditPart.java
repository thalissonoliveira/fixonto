 ...
 * @generated
 */
public class CaracteristicaAgrupadaProdutoNomeEditPart extends
			...
			parser = CaracteristicaParserProvider
					.getParser(
							...
							CaracteristicaVisualIDRegistry
									.getType(caracteristica.diagram.edit.parts.CaracteristicaAgrupadaProdutoNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
