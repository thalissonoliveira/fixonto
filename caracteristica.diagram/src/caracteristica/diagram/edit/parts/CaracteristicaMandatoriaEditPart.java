...
import caracteristica.diagram.edit.policies.CaracteristicaMandatoriaItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaracteristicaMandatoriaEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CaracteristicaMandatoriaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CaracteristicaMandatoriaItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CaracteristicaMandatoriaFigure();
	}

	/**
	 * @generated
	 */
	public CaracteristicaMandatoriaFigure getPrimaryShape() {
		return (CaracteristicaMandatoriaFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CaracteristicaMandatoriaNomeEditPart) {
			((CaracteristicaMandatoriaNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCaracteristicaMandatoriaLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof caracteristica.diagram.edit.parts.CaracteristicaMandatoriaEditPart) {
			types.add(CaracteristicaElementTypes.CaracteristicaCaracteristicaFilha_4002);
		}
	 ...
	 * @generated
	 */
	public class CaracteristicaMandatoriaFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureCaracteristicaMandatoriaLabelFigure;

		/**
		 * @generated
		 */
		public CaracteristicaMandatoriaFigure() {
			this.setLineWidth(2);
		...
		private void createContents() {
			...
			fFigureCaracteristicaMandatoriaLabelFigure = new WrappingLabel();

			fFigureCaracteristicaMandatoriaLabelFigure
					.setText("CaracteristicaMandatoria");

			this.add(fFigureCaracteristicaMandatoriaLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCaracteristicaMandatoriaLabelFigure() {
			return fFigureCaracteristicaMandatoriaLabelFigure;
		}
