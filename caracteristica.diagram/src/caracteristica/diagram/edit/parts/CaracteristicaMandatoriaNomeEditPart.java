 ...
 * @generated
 */
public class CaracteristicaMandatoriaNomeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CaracteristicaMandatoriaNomeEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return CaracteristicaElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.CaracteristicaMandatoria_2004,
					getParserElement(), CaracteristicaVisualIDRegistry
							.getType(caracteristica.diagram.edit.parts.CaracteristicaMandatoriaNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
