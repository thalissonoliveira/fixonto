 ...
 * @generated
 */
public class CaracteristicaMandatoriaProdutoNomeEditPart extends
			...
			parser = CaracteristicaParserProvider
					.getParser(
							...
							CaracteristicaVisualIDRegistry
									.getType(caracteristica.diagram.edit.parts.CaracteristicaMandatoriaProdutoNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
