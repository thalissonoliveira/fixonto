 ...
 * @generated
 */
public class CaracteristicaMandatoriaProdutoNomeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CaracteristicaMandatoriaProdutoNomeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(
					CaracteristicaElementTypes.CaracteristicaMandatoriaProduto_2025, getParserElement(),
					CaracteristicaVisualIDRegistry.getType(
							caracteristica.diagram.edit.parts.CaracteristicaMandatoriaProdutoNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
