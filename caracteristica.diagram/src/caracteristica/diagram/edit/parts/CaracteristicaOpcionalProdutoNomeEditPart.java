 ...
 * @generated
 */
public class CaracteristicaOpcionalProdutoNomeEditPart extends
			...
			parser = CaracteristicaParserProvider
					.getParser(
							...
							CaracteristicaVisualIDRegistry
									.getType(caracteristica.diagram.edit.parts.CaracteristicaOpcionalProdutoNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
