 ...
 * @generated
 */
public class CaracteristicaOpcionalProdutoNomeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CaracteristicaOpcionalProdutoNomeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(
					CaracteristicaElementTypes.CaracteristicaOpcionalProduto_2026, getParserElement(),
					CaracteristicaVisualIDRegistry.getType(
							caracteristica.diagram.edit.parts.CaracteristicaOpcionalProdutoNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
