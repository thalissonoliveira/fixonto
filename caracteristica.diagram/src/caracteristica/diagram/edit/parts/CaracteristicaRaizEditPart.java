...
import caracteristica.diagram.edit.policies.CaracteristicaRaizItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaracteristicaRaizEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CaracteristicaRaizEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CaracteristicaRaizItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CaracteristicaRaizFigure();
	}

	/**
	 * @generated
	 */
	public CaracteristicaRaizFigure getPrimaryShape() {
		return (CaracteristicaRaizFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CaracteristicaRaizNomeEditPart) {
			((CaracteristicaRaizNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCaracteristicaRaizLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof caracteristica.diagram.edit.parts.CaracteristicaRaizEditPart) {
			types.add(CaracteristicaElementTypes.CaracteristicaCaracteristicaFilha_4002);
		}
	 ...
	 * @generated
	 */
	public class CaracteristicaRaizFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureCaracteristicaRaizLabelFigure;

		/**
		 * @generated
		 */
		public CaracteristicaRaizFigure() {
		...
		private void createContents() {
			...
			fFigureCaracteristicaRaizLabelFigure = new WrappingLabel();

			fFigureCaracteristicaRaizLabelFigure.setText("CaracteristicaRaiz");

			this.add(fFigureCaracteristicaRaizLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCaracteristicaRaizLabelFigure() {
			return fFigureCaracteristicaRaizLabelFigure;
		}
