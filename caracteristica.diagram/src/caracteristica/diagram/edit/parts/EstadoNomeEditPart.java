 ...
 * @generated
 */
public class EstadoNomeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EstadoNomeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.Estado_3001, getParserElement(),
					CaracteristicaVisualIDRegistry
							.getType(caracteristica.diagram.edit.parts.EstadoNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
