...
import caracteristica.diagram.edit.policies.EventoLogicoLadoDireitoEventoItemSemanticEditPolicy;
...
public class EventoLogicoLadoDireitoEventoEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	 ...
	 * @generated
	 */
	public EventoLogicoLadoDireitoEventoEditPart(View view) {
		super(view);
	}
	...
	protected Connection createConnectionFigure() {
		return new EventoLogicoLadoDireitoEventoFigure();
	}

	/**
	 * @generated
	 */
	public EventoLogicoLadoDireitoEventoFigure getPrimaryShape() {
		return (EventoLogicoLadoDireitoEventoFigure) getFigure();
	}
	...
	public class EventoLogicoLadoDireitoEventoFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		public EventoLogicoLadoDireitoEventoFigure() {
			this.setLineWidth(3);
