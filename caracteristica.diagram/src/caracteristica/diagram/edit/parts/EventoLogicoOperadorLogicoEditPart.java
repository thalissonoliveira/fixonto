 ...
 * @generated
 */
public class EventoLogicoOperadorLogicoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventoLogicoOperadorLogicoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.EventoLogico_2006,
					getParserElement(), CaracteristicaVisualIDRegistry
							.getType(caracteristica.diagram.edit.parts.EventoLogicoOperadorLogicoEditPart.VISUAL_ID));
		}
		return parser;
	}
