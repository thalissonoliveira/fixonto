 ...
 * @generated
 */
public class ExpressaoLogicaOperadorLogicoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ExpressaoLogicaOperadorLogicoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.ExpressaoLogica_2038,
					getParserElement(), CaracteristicaVisualIDRegistry.getType(
							caracteristica.diagram.edit.parts.ExpressaoLogicaOperadorLogicoEditPart.VISUAL_ID));
		}
		return parser;
	}
