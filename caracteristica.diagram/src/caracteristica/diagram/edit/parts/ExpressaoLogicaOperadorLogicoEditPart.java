 ...
 * @generated
 */
public class ExpressaoLogicaOperadorLogicoEditPart extends CompartmentEditPart
			...
			parser = CaracteristicaParserProvider
					.getParser(
							...
							CaracteristicaVisualIDRegistry
									.getType(caracteristica.diagram.edit.parts.ExpressaoLogicaOperadorLogicoEditPart.VISUAL_ID));
		}
		return parser;
	}
