 ...
 * @generated
 */
public class InformacaoDeContextoNomeValorEditPart extends CompartmentEditPart
			...
			parser = CaracteristicaParserProvider
					.getParser(
							...
							CaracteristicaVisualIDRegistry
									.getType(caracteristica.diagram.edit.parts.InformacaoDeContextoNomeValorEditPart.VISUAL_ID));
		}
		return parser;
	}
