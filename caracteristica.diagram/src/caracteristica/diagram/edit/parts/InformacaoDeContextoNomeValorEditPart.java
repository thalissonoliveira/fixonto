 ...
 * @generated
 */
public class InformacaoDeContextoNomeValorEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InformacaoDeContextoNomeValorEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.InformacaoDeContexto_2029,
					getParserElement(), CaracteristicaVisualIDRegistry.getType(
							caracteristica.diagram.edit.parts.InformacaoDeContextoNomeValorEditPart.VISUAL_ID));
		}
		return parser;
	}
