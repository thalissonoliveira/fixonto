...
import caracteristica.diagram.edit.commands.CaracteristicaCreateShortcutDecorationsCommand;
import caracteristica.diagram.edit.policies.LPSCanonicalEditPolicy;
import caracteristica.diagram.edit.policies.LPSItemSemanticEditPolicy;
import caracteristica.diagram.part.CaracteristicaVisualIDRegistry;

/**
 * @generated
 */
public class LPSEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "Caracteristica"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LPSItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new LPSCanonicalEditPolicy());
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new CaracteristicaCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
