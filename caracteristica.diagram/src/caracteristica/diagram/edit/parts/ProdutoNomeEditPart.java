 ...
 * @generated
 */
public class ProdutoNomeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ProdutoNomeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.Produto_2005, getParserElement(),
					CaracteristicaVisualIDRegistry
							.getType(caracteristica.diagram.edit.parts.ProdutoNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
