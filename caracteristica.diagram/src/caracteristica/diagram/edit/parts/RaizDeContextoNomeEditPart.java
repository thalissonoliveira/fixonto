 ...
 * @generated
 */
public class RaizDeContextoNomeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RaizDeContextoNomeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.RaizDeContexto_2034,
					getParserElement(), CaracteristicaVisualIDRegistry
							.getType(caracteristica.diagram.edit.parts.RaizDeContextoNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
