...
import caracteristica.diagram.edit.policies.RegraDeComposicaoAntecedenteItemSemanticEditPolicy;
...
public class RegraDeComposicaoAntecedenteEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	 ...
	 * @generated
	 */
	public RegraDeComposicaoAntecedenteEditPart(View view) {
		super(view);
	}
	...
	protected Connection createConnectionFigure() {
		return new RegraDeComposicaoAntecedenteFigure();
	}

	/**
	 * @generated
	 */
	public RegraDeComposicaoAntecedenteFigure getPrimaryShape() {
		return (RegraDeComposicaoAntecedenteFigure) getFigure();
	}
	...
	public class RegraDeComposicaoAntecedenteFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		public RegraDeComposicaoAntecedenteFigure() {
