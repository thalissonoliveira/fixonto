 ...
 * @generated
 */
public class RegraDeComposicaoAntecedenteExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CaracteristicaVisualIDRegistry.getType(
						caracteristica.diagram.edit.parts.RegraDeComposicaoAntecedenteExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public RegraDeComposicaoAntecedenteExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(
					CaracteristicaElementTypes.RegraDeComposicaoAntecedente_4029, getParserElement(),
	...
	protected IFigure createFigurePrim() {
		return new RegraDeComposicaoAntecedenteExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RegraDeComposicaoAntecedenteExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RegraDeComposicaoAntecedenteExternalLabelFigure() {
