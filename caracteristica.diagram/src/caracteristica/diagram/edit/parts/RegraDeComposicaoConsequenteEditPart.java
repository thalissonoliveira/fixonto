...
import caracteristica.diagram.edit.policies.RegraDeComposicaoConsequenteItemSemanticEditPolicy;
...
public class RegraDeComposicaoConsequenteEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	 ...
	 * @generated
	 */
	public RegraDeComposicaoConsequenteEditPart(View view) {
		super(view);
	}
	...
	protected Connection createConnectionFigure() {
		return new RegraDeComposicaoConsequenteFigure();
	}

	/**
	 * @generated
	 */
	public RegraDeComposicaoConsequenteFigure getPrimaryShape() {
		return (RegraDeComposicaoConsequenteFigure) getFigure();
	}
	...
	public class RegraDeComposicaoConsequenteFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		public RegraDeComposicaoConsequenteFigure() {
