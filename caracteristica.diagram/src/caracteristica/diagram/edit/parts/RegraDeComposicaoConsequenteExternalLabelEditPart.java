...
import caracteristica.diagram.edit.policies.CaracteristicaTextSelectionEditPolicy;
 ...
 * @generated
 */
public class RegraDeComposicaoConsequenteExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CaracteristicaVisualIDRegistry.getType(
						caracteristica.diagram.edit.parts.RegraDeComposicaoConsequenteExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public RegraDeComposicaoConsequenteExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(
					CaracteristicaElementTypes.RegraDeComposicaoConsequente_4030, getParserElement(),
	...
	protected IFigure createFigurePrim() {
		return new RegraDeComposicaoConsequenteExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RegraDeComposicaoConsequenteExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RegraDeComposicaoConsequenteExternalLabelFigure() {
