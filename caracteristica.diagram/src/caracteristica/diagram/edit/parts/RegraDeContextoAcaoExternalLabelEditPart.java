 ...
 * @generated
 */
public class RegraDeContextoAcaoExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CaracteristicaVisualIDRegistry
						.getType(caracteristica.diagram.edit.parts.RegraDeContextoAcaoExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public RegraDeContextoAcaoExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.RegraDeContextoAcao_4015,
	...
	protected IFigure createFigurePrim() {
		return new RegraDeContextoAcaoExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RegraDeContextoAcaoExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RegraDeContextoAcaoExternalLabelFigure() {
			this.setText("ação");
		}
