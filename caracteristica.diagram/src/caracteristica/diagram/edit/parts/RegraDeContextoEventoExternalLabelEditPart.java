 ...
 * @generated
 */
public class RegraDeContextoEventoExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CaracteristicaVisualIDRegistry.getType(
						caracteristica.diagram.edit.parts.RegraDeContextoEventoExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public RegraDeContextoEventoExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.RegraDeContextoEvento_4014,
	...
	protected IFigure createFigurePrim() {
		return new RegraDeContextoEventoExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RegraDeContextoEventoExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RegraDeContextoEventoExternalLabelFigure() {
			this.setText("evento");
		}
