...
import caracteristica.diagram.edit.policies.OpenDiagramEditPolicy;
import caracteristica.diagram.edit.policies.SimulacaoItemSemanticEditPolicy;
import caracteristica.diagram.part.CaracteristicaVisualIDRegistry;

/**
 * @generated
 */
public class SimulacaoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SimulacaoEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createNodeShape() {
		return primaryShape = new SimulacaoFigure();
	}

	/**
	 * @generated
	 */
	public SimulacaoFigure getPrimaryShape() {
		return (SimulacaoFigure) primaryShape;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof SimulacaoSimulacaoEstadosCompartmentEditPart) {
			return getPrimaryShape().getSimulacaoEstadosCompartmentFigure();
		}
	 ...
	 * @generated
	 */
	public class SimulacaoFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureSimulacaoLabelFigure;
		/**
		 * @generated
		 */
		private RectangleFigure fSimulacaoEstadosCompartmentFigure;
		...
		private void createContents() {
			...
			fSimulacaoEstadosCompartmentFigure = new RectangleFigure();

			fSimulacaoEstadosCompartmentFigure.setOutline(false);

			this.add(fSimulacaoEstadosCompartmentFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureSimulacaoLabelFigure() {
			return fFigureSimulacaoLabelFigure;
		}

		/**
		 * @generated
		 */
		public RectangleFigure getSimulacaoEstadosCompartmentFigure() {
			return fSimulacaoEstadosCompartmentFigure;
		}
