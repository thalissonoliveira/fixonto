 ...
 * @generated
 */
public class TransicaoEtiquetaEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(CaracteristicaVisualIDRegistry
				.getType(caracteristica.diagram.edit.parts.TransicaoEtiquetaEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public TransicaoEtiquetaEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.Transicao_4001,
					getParserElement(), CaracteristicaVisualIDRegistry
							.getType(caracteristica.diagram.edit.parts.TransicaoEtiquetaEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new TransicaoLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TransicaoLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TransicaoLabelFigure() {
			this.setText("Transicao");
		}
