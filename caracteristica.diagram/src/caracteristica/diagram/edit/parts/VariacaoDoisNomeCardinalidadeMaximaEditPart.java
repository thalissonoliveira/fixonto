 ...
 * @generated
 */
public class VariacaoDoisNomeCardinalidadeMaximaEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public VariacaoDoisNomeCardinalidadeMaximaEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.VariacaoDois_2002,
					getParserElement(), CaracteristicaVisualIDRegistry.getType(
							caracteristica.diagram.edit.parts.VariacaoDoisNomeCardinalidadeMaximaEditPart.VISUAL_ID));
		}
		return parser;
	}
