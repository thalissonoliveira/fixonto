 ...
 * @generated
 */
public class VariacaoDoisNomeCardinalidadeMaximaEditPart extends
			...
			parser = CaracteristicaParserProvider
					.getParser(
							...
							CaracteristicaVisualIDRegistry
									.getType(caracteristica.diagram.edit.parts.VariacaoDoisNomeCardinalidadeMaximaEditPart.VISUAL_ID));
		}
		return parser;
	}
