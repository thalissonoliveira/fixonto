...
import utils.DiamondFigure;
import caracteristica.diagram.edit.policies.VariacaoDoisProdutoItemSemanticEditPolicy;
 ...
 * @generated
 */
public class VariacaoDoisProdutoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public VariacaoDoisProdutoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new VariacaoDoisProdutoItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new VariacaoDoisProdutoFigure();
	}

	/**
	 * @generated
	 */
	public VariacaoDoisProdutoFigure getPrimaryShape() {
		return (VariacaoDoisProdutoFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof VariacaoDoisProdutoNomeCardinalidadeMaximaEditPart) {
			((VariacaoDoisProdutoNomeCardinalidadeMaximaEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureVariacaoDoisProdutoLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof caracteristica.diagram.edit.parts.VariacaoDoisProdutoEditPart) {
			types.add(CaracteristicaElementTypes.CaracteristicaProdutoCaracteristicaProdutoFilha_4008);
		}
	 ...
	 * @generated
	 */
	public class VariacaoDoisProdutoFigure extends DiamondFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureVariacaoDoisProdutoLabelFigure;

		/**
		 * @generated
		 */
		public VariacaoDoisProdutoFigure() {
			createContents();
		}
		...
		private void createContents() {
			...
			fFigureVariacaoDoisProdutoLabelFigure = new WrappingLabel();

			fFigureVariacaoDoisProdutoLabelFigure
					.setText("VariacaoDoisProduto");

			this.add(fFigureVariacaoDoisProdutoLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureVariacaoDoisProdutoLabelFigure() {
			return fFigureVariacaoDoisProdutoLabelFigure;
		}
