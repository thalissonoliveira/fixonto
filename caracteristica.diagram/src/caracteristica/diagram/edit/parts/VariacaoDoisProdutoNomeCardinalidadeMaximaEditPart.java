 ...
 * @generated
 */
public class VariacaoDoisProdutoNomeCardinalidadeMaximaEditPart extends
			...
			parser = CaracteristicaParserProvider
					.getParser(
							...
							CaracteristicaVisualIDRegistry
									.getType(caracteristica.diagram.edit.parts.VariacaoDoisProdutoNomeCardinalidadeMaximaEditPart.VISUAL_ID));
		}
		return parser;
	}
