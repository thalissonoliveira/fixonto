 ...
 * @generated
 */
public class VariacaoDoisProdutoNomeCardinalidadeMaximaEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public VariacaoDoisProdutoNomeCardinalidadeMaximaEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(CaracteristicaElementTypes.VariacaoDoisProduto_2027,
					getParserElement(), CaracteristicaVisualIDRegistry.getType(
							caracteristica.diagram.edit.parts.VariacaoDoisProdutoNomeCardinalidadeMaximaEditPart.VISUAL_ID));
		}
		return parser;
	}
