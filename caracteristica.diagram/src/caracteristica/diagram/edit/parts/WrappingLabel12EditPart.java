 ...
 * @generated
 */
public class WrappingLabel12EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(CaracteristicaVisualIDRegistry
				.getType(caracteristica.diagram.edit.parts.WrappingLabel12EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(
					CaracteristicaElementTypes.EventoLogicoLadoDireitoEvento_4016, getParserElement(),
