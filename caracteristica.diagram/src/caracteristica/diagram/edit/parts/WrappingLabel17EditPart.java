 ...
 * @generated
 */
public class WrappingLabel17EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(CaracteristicaVisualIDRegistry
				.getType(caracteristica.diagram.edit.parts.WrappingLabel17EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(
					CaracteristicaElementTypes.ExpressaoLogicaLadoEsquerdoComposicao_4021, getParserElement(),
