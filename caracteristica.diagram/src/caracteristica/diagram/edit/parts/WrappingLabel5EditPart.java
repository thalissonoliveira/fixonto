 ...
 * @generated
 */
public class WrappingLabel5EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(CaracteristicaVisualIDRegistry
				.getType(caracteristica.diagram.edit.parts.WrappingLabel5EditPart.VISUAL_ID), new Point(0, 40));
	}
