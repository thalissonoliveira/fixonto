 ...
 * @generated
 */
public class WrappingLabel7EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(CaracteristicaVisualIDRegistry
				.getType(caracteristica.diagram.edit.parts.WrappingLabel7EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CaracteristicaParserProvider.getParser(
					CaracteristicaElementTypes.EntidadeDeContextoInformacoesDeContexto_4023, getParserElement(),
