...
public class LPSCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(CaracteristicaPackage.eINSTANCE.getLPS_Elementos());
			myFeaturesToSynchronize.add(CaracteristicaPackage.eINSTANCE.getLPS_Produtos());
			myFeaturesToSynchronize.add(CaracteristicaPackage.eINSTANCE.getLPS_Expressoes());
			myFeaturesToSynchronize.add(CaracteristicaPackage.eINSTANCE.getLPS_ElementosDeProduto());
			myFeaturesToSynchronize.add(CaracteristicaPackage.eINSTANCE.getLPS_Externos());
			myFeaturesToSynchronize.add(CaracteristicaPackage.eINSTANCE.getLPS_Regras());
			myFeaturesToSynchronize.add(CaracteristicaPackage.eINSTANCE.getLPS_Simulacoes());
		}
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<CaracteristicaLinkDescriptor> linkDescriptors = collectAllLinks(getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = CaracteristicaVisualIDRegistry.getVisualID(nextDiagramLink);
			...
			for (Iterator<CaracteristicaLinkDescriptor> linkDescriptorsIterator = linkDescriptors
				...
				CaracteristicaLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator.next();
	 ...
	 * @generated
	 */
	private Collection<CaracteristicaLinkDescriptor> collectAllLinks(View view, Domain2Notation domain2NotationMap) {
		if (!LPSEditPart.MODEL_ID.equals(CaracteristicaVisualIDRegistry.getModelID(view))) {
		...
		case LPSEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getLPS_1000ContainedLinks(view));
			}
		...
		case CaracteristicaOpcionalEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getCaracteristicaOpcional_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case CaracteristicaAgrupadaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getCaracteristicaAgrupada_2033ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case VariacaoDoisEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getVariacaoDois_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case CaracteristicaRaizEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getCaracteristicaRaiz_2003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case CaracteristicaMandatoriaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getCaracteristicaMandatoria_2004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ProdutoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getProduto_2005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case EventoLogicoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getEventoLogico_2006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case EventoRelacionalEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getEventoRelacional_2007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case AcaoLogicoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getAcaoLogico_2008ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case LiteralAcaoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getLiteralAcao_2009ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DesignarEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getDesignar_2010ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ExpressaoLogicaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getExpressaoLogica_2011ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ExpressaoRelacionalEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getExpressaoRelacional_2012ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case LiteralComposicaoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getLiteralComposicao_2013ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case CaracteristicaMandatoriaProdutoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getCaracteristicaMandatoriaProduto_2025ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case CaracteristicaOpcionalProdutoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getCaracteristicaOpcionalProduto_2026ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case VariacaoDoisProdutoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getVariacaoDoisProduto_2027ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case CaracteristicaAgrupadaProdutoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getCaracteristicaAgrupadaProduto_2035ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case AtributoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getAtributo_2017ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case RaizDeContextoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getRaizDeContexto_2018ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case EntidadeDeContextoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getEntidadeDeContexto_2028ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case InformacaoDeContextoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getInformacaoDeContexto_2029ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case CasoDeUsoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getCasoDeUso_2038ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case CasoDeTesteEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getCasoDeTeste_2039ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case RegraDeComposicaoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getRegraDeComposicao_2021ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case RegraDeContextoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getRegraDeContexto_2022ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case AtributoProdutoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getAtributoProduto_2030ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case SimulacaoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getSimulacao_2024ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case EstadoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getEstado_3001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TransicaoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CaracteristicaDiagramUpdater.getTransicao_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
	 ...
	 * @generated
	 */
	private Collection<IAdaptable> createConnections(Collection<CaracteristicaLinkDescriptor> linkDescriptors,
		...
		for (CaracteristicaLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					CaracteristicaVisualIDRegistry.getType(nextLinkDescriptor.getVisualID()), ViewUtil.APPEND, false,
