...
public class CaracteristicaNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case LPSEditPart.VISUAL_ID: {
			...
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ContextoEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
			...
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ContextoCaracteristicasIncluirEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ContextoCaracteristicasExcluirEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
		...
		case RaizDeContextoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			CaracteristicaNavigatorGroup outgoinglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_RaizDeContexto_2034_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ContextoCaracteristicasIncluirEditPart.VISUAL_ID));
		...
		case EntidadeDeContextoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			CaracteristicaNavigatorGroup outgoinglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_EntidadeDeContexto_2035_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup incominglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_EntidadeDeContexto_2035_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ContextoCaracteristicasIncluirEditPart.VISUAL_ID));
		...
		case InformacaoDeContextoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			CaracteristicaNavigatorGroup outgoinglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_InformacaoDeContexto_2036_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup incominglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_InformacaoDeContexto_2036_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ContextoCaracteristicasIncluirEditPart.VISUAL_ID));
		...
		case ContextoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			CaracteristicaNavigatorGroup outgoinglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_Contexto_2037_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ContextoCaracteristicasIncluirEditPart.VISUAL_ID));
		...
		case ExpressaoLogicaEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			CaracteristicaNavigatorGroup incominglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ExpressaoLogica_2038_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup outgoinglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ExpressaoLogica_2038_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(RegraDeComposicaoAntecedenteEditPart.VISUAL_ID));
		...
		case ExpressaoRelacionalEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			CaracteristicaNavigatorGroup incominglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ExpressaoRelacional_2039_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(RegraDeComposicaoAntecedenteEditPart.VISUAL_ID));
		...
		case LiteralComposicaoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			CaracteristicaNavigatorGroup incominglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_LiteralComposicao_2040_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(RegraDeComposicaoAntecedenteEditPart.VISUAL_ID));
		...
		case RegraDeComposicaoEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			CaracteristicaNavigatorGroup outgoinglinks = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_RegraDeComposicao_2041_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(RegraDeComposicaoAntecedenteEditPart.VISUAL_ID));
		...
		case ContextoCaracteristicasIncluirEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			CaracteristicaNavigatorGroup target = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ContextoCaracteristicasIncluir_4025_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup source = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ContextoCaracteristicasIncluir_4025_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(CaracteristicaOpcionalEditPart.VISUAL_ID));
		...
		case ContextoCaracteristicasExcluirEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			CaracteristicaNavigatorGroup target = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ContextoCaracteristicasExcluir_4026_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup source = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ContextoCaracteristicasExcluir_4026_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(CaracteristicaOpcionalEditPart.VISUAL_ID));
		...
		case RaizDeContextoEntidadesDeContextoEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			CaracteristicaNavigatorGroup target = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_RaizDeContextoEntidadesDeContexto_4027_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup source = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_RaizDeContextoEntidadesDeContexto_4027_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(EntidadeDeContextoEditPart.VISUAL_ID));
		...
		case EntidadeDeContextoInformacoesDeContextoEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			CaracteristicaNavigatorGroup target = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_EntidadeDeContextoInformacoesDeContexto_4028_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup source = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_EntidadeDeContextoInformacoesDeContexto_4028_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(InformacaoDeContextoEditPart.VISUAL_ID));
		...
		case RegraDeComposicaoAntecedenteEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			CaracteristicaNavigatorGroup target = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_RegraDeComposicaoAntecedente_4029_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup source = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_RegraDeComposicaoAntecedente_4029_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ExpressaoLogicaEditPart.VISUAL_ID));
		...
		case RegraDeComposicaoConsequenteEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			CaracteristicaNavigatorGroup target = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_RegraDeComposicaoConsequente_4030_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup source = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_RegraDeComposicaoConsequente_4030_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ExpressaoLogicaEditPart.VISUAL_ID));
		...
		case ExpressaoLogicaLadoDireitoComposicaoEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			CaracteristicaNavigatorGroup target = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ExpressaoLogicaLadoDireitoComposicao_4031_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup source = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ExpressaoLogicaLadoDireitoComposicao_4031_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ExpressaoLogicaEditPart.VISUAL_ID));
		...
		case ExpressaoLogicaLadoEsquerdoComposicaoEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			CaracteristicaNavigatorGroup target = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ExpressaoLogicaLadoEsquerdoComposicao_4032_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CaracteristicaNavigatorGroup source = new CaracteristicaNavigatorGroup(
					Messages.NavigatorGroupName_ExpressaoLogicaLadoEsquerdoComposicao_4032_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					CaracteristicaVisualIDRegistry.getType(ExpressaoLogicaEditPart.VISUAL_ID));
