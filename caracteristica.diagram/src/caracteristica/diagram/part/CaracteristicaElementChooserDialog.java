 ...
 * @generated
 */
public class CaracteristicaElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public CaracteristicaElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.CaracteristicaElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "caracteristica".equals(fileExtension); //$NON-NLS-1$
	}
