 ...
 * @generated
 */
public class CaracteristicaMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = CaracteristicaDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			CaracteristicaDiagramEditorUtil.selectElementsInDiagram(editor,
