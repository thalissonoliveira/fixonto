 ...
 * @generated
 */
public class CaracteristicaValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = CaracteristicaDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof CaracteristicaDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& LPSEditPart.MODEL_ID.equals(CaracteristicaVisualIDRegistry
						.getModelID(view));
	}
