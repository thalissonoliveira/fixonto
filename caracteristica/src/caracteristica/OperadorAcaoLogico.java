 ...
 * @generated
 */
public enum OperadorAcaoLogico implements Enumerator
{
  /**
   ...
   * @generated
   */
  private static final OperadorAcaoLogico[] VALUES_ARRAY =
    new OperadorAcaoLogico[]
    {
      AND,
    };
   ...
   * @generated
   */
  public static final List<OperadorAcaoLogico> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
   ...
   * @generated
   */
  public static OperadorAcaoLogico get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      OperadorAcaoLogico result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static OperadorAcaoLogico getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      OperadorAcaoLogico result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static OperadorAcaoLogico get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private OperadorAcaoLogico(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
