...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Operador Relacional</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see caracteristica.CaracteristicaPackage#getOperadorRelacional()
 * @model
 * @generated
 */
public enum OperadorRelacional implements Enumerator
{
  /**
   ...
   * @generated
   */
  private static final OperadorRelacional[] VALUES_ARRAY =
    new OperadorRelacional[]
    {
      MAIOR,
      MENOR,
      IGUAL,
   ...
   * @generated
   */
  public static final List<OperadorRelacional> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
   ...
   * @generated
   */
  public static OperadorRelacional get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      OperadorRelacional result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static OperadorRelacional getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      OperadorRelacional result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static OperadorRelacional get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private OperadorRelacional(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
