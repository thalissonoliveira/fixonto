 ...
 * @generated
 */
public enum Presenca implements Enumerator
{
  /**
   ...
   * @generated
   */
  private static final Presenca[] VALUES_ARRAY =
    new Presenca[]
    {
      PRESENTE,
      AUSENTE,
   ...
   * @generated
   */
  public static final List<Presenca> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
   ...
   * @generated
   */
  public static Presenca get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      Presenca result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static Presenca getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      Presenca result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static Presenca get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private Presenca(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
